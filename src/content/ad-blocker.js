// Ultimate X Tool — Ad Blocker (MV3 content script)
...
(function () {
    ...
    function replaceWithCat(el) {
        try {
            ...
            const ov = document.createElement('div'); ov.className = 'utt-cat-overlay'; ov.textContent = 'Replaced an ad with a cute cat 🐱';
